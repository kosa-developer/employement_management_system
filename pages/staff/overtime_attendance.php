                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Staff Overtime attendance</div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
//Position array declared in the init file
                                    ...
                                    <div class="card-body ">
                                        ...
                                        $staffCheck = "SELECT * FROM staff,person WHERE staff.Position='Guard' $condition AND  person.Person_Id=staff.Person_Id AND staff.Staff_Status=1 ORDER BY person.Fname";
                                                    ...
                                                    foreach ($staff_list->results() as $staff):
                                                        ...
                                                        <tr>
                                                            ...
                                                            foreach ($daterange as $date) {
                                                                ...
                                                                $checked = (DB::getInstance()->checkRows("SELECT * FROM staff_overtime_attendency WHERE Staff_Id='$staff->Staff_Id' AND Date='$cur_date' AND Is_Present=1")) ? " checked" : "";
        ...
        <script>
            function submitStaffAttendance(element, staff_id, date, entry_number) {
                ...
                $.ajax({
                    ...
                    data: {updateOvertimeStaffAttendance: 'updateOvertimeStaffAttendance', is_present: isPresent, date: date, staff_id: staff_id, user_id: <?php echo $_SESSION['security_user_id'] ?>},
